...
def configure_document(doc: Document, title: str, subject: str) -> None:
    ...
    run = p.add_run("Forge & Verse free release  |  Intake Kit v1.1  |  Adapt to agency policy, law, records requirements, and approved workflows.")
    run.font.name = "Inter"
    run.font.size = Pt(7)
...
def build_implementation_guide() -> Path:
    ...
    steps = [
        ...
        ("Adapt and test", "Customize the files, then run several realistic requests through the full routing and acceptance process."),
