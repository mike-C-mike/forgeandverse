...
4. Run `scripts/package_intake_release.py`.
5. Update the bundle checksum in the release front matter if the package changed.
6. Run `python scripts/validate.py`.
7. Run the full Hugo build and rendered-site validator locally.
